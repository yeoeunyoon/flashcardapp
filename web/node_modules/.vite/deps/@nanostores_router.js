...
// node_modules/.pnpm/@nanostores+router@0.16.1_nanostores@0.10.3/node_modules/@nanostores/router/index.js
...
function getPagePath(router, name, params, search) {
  ...
  let path = route[3].replace(/\/:\w+\?/g, (i) => {
...
function openPage(router, name, params, search) {
  router.open(getPagePath(router, name, params, search));
}
function redirectPage(router, name, params, search) {
...
//# sourceMappingURL=@nanostores_router.js.map
